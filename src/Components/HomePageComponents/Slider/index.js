      ...
      <div className={`slick-block-photo-homepage ${sliderUnder}`}>
        <div className={`${cartSide}  ${borderColor}`}>
          <div className="slider-under-arrows">
            <div onClick={prev} className={`homepage-arrow-circle `}>
              <ArrowLeft />
            </div>
            <div
              onClick={next}
              className={`homepage-arrow-circle  homepage-arrow-circle-2 `}
            >
              <ArrowRight />
            </div>
          </div>
          ...
          <div className="slider-under">
            <div className="homepage-arrow-count">
              ...
              <div
                className="arrowcount-secondspan"
                style={{ fontSize: "24px", color: "#A9A9B9" }}
              >
                /{photos.length}
              </div>
            </div>
            ...
            <div className="homepage-stroke-div" style={{ display: "flex" }}>
              <div
                style={{ width: "56px", height: "4px", background: "#0085FF" }}
              ></div>
              <div
                style={{
                  width: "72px",
